...
if (isset($_GET['input'])) {
    ...
    <table width="100%"  class="tblcms2">
        <tr>
           ...
           <!--h <th class="th_border cell">Id Jadwal </th> h-->
        ...
        <tbody>
            ...
            if (isset($_GET['isi']) && !empty($_GET['isi'])) {
                ...
                $querytabel = "SELECT * FROM data_jadwal where $Berdasarkan like '%$isi%' $q";
                ...
                $querytabel = "SELECT * FROM data_jadwal where ($Berdasarkan BETWEEN '$tanggal1' AND '$tanggal2') $q";
            } else {
                //SEMUA
                $q = str_replace("and","where",$q);
                $querytabel = "SELECT * FROM data_jadwal $q";
            }
