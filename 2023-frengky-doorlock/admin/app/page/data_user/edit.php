                    ...
                    <input type="hidden" class="form-control" name="id_user" value="<?php echo $data['id_user']; ?>" readonly  id="id_user" required="required">
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <option value="<?php echo ($data['id_role']); ?>">- <?php echo baca_database("","role","select * from data_role where id_role='$data[id_role]'"); ?> -</option><?php combo_database_v2('data_role','id_role','role',''); ?>
                                </select>
                            </td>
                        </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                                <input  class="form-control" style="width:50%" type="password" name="password" id="password" placeholder="Password " required="required" value="">
                            </td>
                        </tr>
